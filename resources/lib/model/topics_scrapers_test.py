...
class TestTopicsScraper(unittest.TestCase):
    ...
    def test_get_topics(self):
        ...
        self.assertTrue(isinstance(sample_topic[3], int))
	...
	self.assertEqual('http://images.ted.com/images/ted/8a3803576b960b90b3f55b6c0edab9eb8eb2f0fa_800x600.jpg', sample_talk[2])
